...
namespace WindowsFormsApp2
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string connectionString = "Data Source=DESKTOP-0PVUAO7; Initial Catalog=examen; Integrated Security=true;";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
                ...
                con.ConnectionString = "Data Source=DESKTOP-0PVUAO7; Initial Catalog=examen; Integrated Security=true;";
                string query = "SELECT * FROM puntos";
